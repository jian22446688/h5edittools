...
export const USER_POST_LOGIN        = 'login'
export const USER_GET_LOGOUT        = 'logout'
export const USER_POST_REGISTER     = 'register'
export const USER_GET_USERINFO      = 'getuserinfo'
...
export const ADD_UPLOAD_IMG         = 'ADD_UPLOAD_IMG'              // 用户操作上传图片
